    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        appBarTheme: const AppBarTheme(
          backgroundColor: Color(0xFF1F5F33),
          foregroundColor: Color(0xFF143D24),
          centerTitle: true,
          elevation: 0,
        ...
        cardTheme: const CardThemeData(
          ...
          surfaceTintColor: Color(0xFFE4F4E7),
          elevation: 0,
          margin: EdgeInsets.zero,
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.all(Radius.circular(14)),
            side: BorderSide(color: Color(0xFFD3E8D8)),
          ),
        ),
        inputDecorationTheme: InputDecorationTheme(
          filled: true,
          fillColor: const Color(0xFFFFFFFF),
          labelStyle: const TextStyle(color: Color(0xFF2F6B3D)),
          helperStyle: const TextStyle(color: Color(0xFF587665)),
          enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(10),
            borderSide: const BorderSide(color: Color(0xFF7FB38B)),
          ),
        ...
        filledButtonTheme: FilledButtonThemeData(
          style: FilledButton.styleFrom(
            ...
            disabledBackgroundColor: const Color(0xFFB9D6BE),
            disabledForegroundColor: const Color(0xFFEEF7F0),
        ...
        switchTheme: SwitchThemeData(
          thumbColor: WidgetStateProperty.resolveWith((states) {
            ...
            return const Color(0xFF6C8171);
          }),
          trackColor: WidgetStateProperty.resolveWith((states) {
            if (states.contains(WidgetState.selected)) {
              return const Color(0xFF4F9A5A);
            }
            return const Color(0xFFD6E5DA);
          }),
        ),
        useMaterial3: true,
      ),
            ...
            Row(
              children: [
                Container(
                  ...
                  child: Icon(icon, color: const Color(0xFF1F6B35)),
                ),
...
''';
  ...
  Widget build(BuildContext context) {
    final statusColor = approved == true
        ...
        : approved == false
        ? const Color(0xFFB84A2B)
        : const Color(0xFF6C8171);
            ...
            children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(color: Color(0xFFCDEBD4)),
                          ),
                        ],
                      ),
                    ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: const Color(0xFFD3E8D8)),
                  borderRadius: BorderRadius.circular(14),
                ),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.stretch,
